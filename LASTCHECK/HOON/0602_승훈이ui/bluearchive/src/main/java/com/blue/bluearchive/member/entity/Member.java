...
public class Member extends BaseEntity {
    ...
    public static com.blue.bluearchive.member.entity.Member createMember(MemberFormDto memberFormDto, PasswordEncoder passwordEncoder){
        com.blue.bluearchive.member.entity.Member member = new com.blue.bluearchive.member.entity.Member();
