...
public class BoardService {
    ...
    public BoardFormDto getBoardImgById(int boardId){
        ...
        public Integer updateBoard(BoardFormDto boardFormDto,List<MultipartFile> boardImgFileList)throws Exception{
        ...
        boolean hasNonEmptyFiles = false;
            ...
            if (hasNonEmptyFiles) {
                for(int i=0;i<boardImgFileList.size();i++){
                    List<Integer>boardImgIds = boardFormDto.getBoardImgIds();
