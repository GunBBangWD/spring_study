...
public class QReportBoard extends EntityPathBase<Report> {
    ...
    public final NumberPath<Integer> reportBoardId = createNumber("reportBoardId", Integer.class);
    ...
    public QReportBoard(Path<? extends Report> path) {
    ...
    public QReportBoard(Class<? extends Report> type, PathMetadata metadata, PathInits inits) {
