...
public class QCommentsComment extends EntityPathBase<CommentsComment> {
    ...
    public final ListPath<CommentsCommentLikeHate, QCommentsCommentLikeHate> commentsCommentLikeHate = this.<CommentsCommentLikeHate, QCommentsCommentLikeHate>createList("commentsCommentLikeHate", CommentsCommentLikeHate.class, QCommentsCommentLikeHate.class, PathInits.DIRECT2);
