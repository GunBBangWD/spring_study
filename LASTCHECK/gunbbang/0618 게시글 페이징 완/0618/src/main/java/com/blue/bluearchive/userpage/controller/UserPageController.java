...
import com.blue.bluearchive.userpage.service.UserInterestLogService;
...
public class UserPageController {
    ...
    private final UserInterestLogService userInterestLogService;
    ...
    public String myPage(Model model){
        ...
        List<UserMainCategoryDto> userMainCategoryDtoList = userInterestLogService.getCategoryLogData(userIdx);
    ...
    public String grapInformation(){
        userInterestLogService.logAllUserCategoryCount();
