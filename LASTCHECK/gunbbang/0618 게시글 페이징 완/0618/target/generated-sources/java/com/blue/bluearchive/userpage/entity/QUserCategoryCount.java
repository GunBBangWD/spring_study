...
public class QUserCategoryCount extends EntityPathBase<UserInterestCount> {
    ...
    public QUserCategoryCount(Path<? extends UserInterestCount> path) {
    ...
    public QUserCategoryCount(Class<? extends UserInterestCount> type, PathMetadata metadata, PathInits inits) {
