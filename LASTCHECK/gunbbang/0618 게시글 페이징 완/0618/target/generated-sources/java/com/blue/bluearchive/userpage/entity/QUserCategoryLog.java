...
public class QUserCategoryLog extends EntityPathBase<UserInterestLog> {
    ...
    public QUserCategoryLog(Path<? extends UserInterestLog> path) {
    ...
    public QUserCategoryLog(Class<? extends UserInterestLog> type, PathMetadata metadata, PathInits inits) {
