...
public class BoardImgService {
    ...
    public void saveBoardImg(BoardImg boardImg, MultipartFile boardImgFile) throws Exception{
        ...
        //상품 이미지 정보 저장
        boardImg.updateItemImg(oriImgName,imgName,boardImgUrl);
        boardImgRepository.save(boardImg);
    }

    public void updateItemImg(Integer boardImgId,MultipartFile boardImgFile) throws Exception{
        if(!boardImgFile.isEmpty()){
            ...
            savedBoardImg.updateItemImg(oriImgName,imgName,boardImgUrl);
        }
    }
}
