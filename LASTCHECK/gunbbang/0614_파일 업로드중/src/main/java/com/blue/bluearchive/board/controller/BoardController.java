...
//    }
    ...
    public String boardNew(
            @Valid BoardForm2Dto boardFormDto,
            BindingResult bindingResult,
            @RequestPart("boardImgFile") MultipartFile[] boardImgFiles,
            @RequestPart("foodImgFile") MultipartFile[] foodImgFile) {

        System.out.println("==================컨트롤러 진입 텍스트 객체 출력============");
        System.out.println(boardFormDto);
        if(bindingResult.hasErrors()){
            System.out.println("================유효성검사부분=================");
            return "유혀성검사 실패";
        }
        System.out.println("==================보드파일 리스트 출력============");
        for (MultipartFile file : boardImgFiles) {
            System.out.println("File name: " + file.getName());
            System.out.println("Original file name: " + file.getOriginalFilename());
            System.out.println("File size: " + file.getSize());
        }
        System.out.println("==================음식파일 리스트 출력============");
        for (MultipartFile file : foodImgFile) {
            System.out.println("File name: " + file.getName());
            System.out.println("Original file name: " + file.getOriginalFilename());
            System.out.println("File size: " + file.getSize());
        }
        return "Data and files uploaded successfully!";
    }
