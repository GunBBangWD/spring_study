...
import com.blue.bluearchive.shop.dto.ItemImgDto;
...
////        Item item = itemRepository.findByItemUseabilityAndId(ItemUseability.ABLE, itemId).orElseThrow(EntityNotFoundException::new);
//
...
//        return itemFormDto;
        ...
        Item item = itemRepository.findById(itemId).orElseThrow(EntityNotFoundException::new);
 		Member member = memberRepository.findByEmail(item.getCreatedBy());
        // itemUseability이 'ABLE'인 경우에만 값을 설정
