...
public class TreeMapRun {
    public static void main(String[] args) {
        ...
        System.out.println("---------인자로 받은 이덱스 기준 바로 자신을 제외 다음(higher)과 이전(lower) 것을 반환 -----------");
        ...
        System.out.println(tmap.headMap(18));  //인자보다 키값이 작은 것들을 반환
        System.out.println(tmap.headMap(18, true)); //인자와 키값이 같은것 포함 작은것들을 반환
        System.out.println(tmap.tailMap(32)); //인자보다 키값이 큰것들을 반환
        System.out.println(tmap.tailMap(32, false)); //인자보다 키값이 큰것들을 반환 뒤에 true, false가 같은거 포함 여부 판단 그리고 이전 정했다면 그대로 사용
